...
from hammerdirtApi.views import (
    ...
    DimDataCreate,
    SwissBeachList,
    ViewSwissBeachesByCategory,
    ViewSwissBeachCategories,
    ViewSwissWaterBodyCodeTotals,
    ViewSwissCityCodeTotals,
    # ViewSwissPostCodeTotals,
    SurveyResultsListView,
    ViewSwissLitterDataPieces,
    ViewSwissCodeTotalsByBeachAndDay,
    ViewLatestSwissInventories
)
urlpatterns = [
    ...
    path('code-totals/water-bodies/swiss/', ViewSwissWaterBodyCodeTotals.as_view(), name="swiss-water-body-code-totals"),
    path('code-totals/cities/swiss/', ViewSwissCityCodeTotals.as_view(), name="swiss-city-code-totals"),
    # path('code-totals/post-code/swiss/', ViewSwissPostCodeTotals.as_view(), name="swiss-postal-code-totals"),
    ...
    path('list-of-beaches/swiss/', SwissBeachList.as_view(), name='list-of-swiss-beaches'),
    path('list-of-beaches/by-category/', ViewBeachesByCategory.as_view(), name='beaches-by-location'),
    path('list-of-beaches/by-category/swiss/', ViewSwissBeachesByCategory.as_view(), name='swiss-beaches-by-location'),
    path('list-of-beaches/categories/', ViewBeachCategories.as_view(), name='category-groups'),
    path('list-of-beaches/categories/swiss/', ViewSwissBeachCategories.as_view(), name='swiss-category-groups'),
    ...
    path('surveys/dim-data/dim-data-list/', DimsDataListView.as_view(), name='dim-data-view'),
    path('surveys/daily-totals/', ViewLitterDataPieces.as_view(), name="pcs-m-day"),
    path('surveys/daily-totals/swiss/', ViewSwissLitterDataPieces.as_view(), name="swiss-pcs-m-day"),
    path('surveys/survey-results/', SurveyResultsListView.as_view(), name='survey-by-code-location'),
    path('surveys/daily-totals/code-totals/', ViewCodeTotalsByBeachAndDay.as_view(), name="code-results"),

    path('surveys/daily-totals/code-totals/swiss/', ViewSwissCodeTotalsByBeachAndDay.as_view(), name="swiss-code-results"),
    path('surveys/daily-totals/code-totals/latest-daily-totals/', ViewLatestInventories.as_view(), name="latest-daily-total"),
    path('surveys/daily-totals/code-totals/latest-daily-totals/swiss/', ViewLatestSwissInventories.as_view(), name="latest-daily-total"),
